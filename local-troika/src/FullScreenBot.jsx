...
const VoiceButton = styled.button`
  ...
  &:active:not(:disabled) {
    transform: ${(props) => (props.$isRecording ? "scale(1.15)" : "scale(1.05)")};
  }
                        ...
                        >
                          {suggestions.map(({ label, icon, bg }, idx) => (
                            ...
                            >
                              ...
                              <span className="label-text" style={{ flex: 1 }}>{label}</span>
                            </button>
                          ))}
                        </div>
                      </div>
                    ...
                    <InputContainer>
                      ...
                      <p
                        style={{
                          ...
                          margin: isMobile ? "0.4rem 0 0 0" : "0.5rem 0 0 0",
                        }}
                      >
                        <a
